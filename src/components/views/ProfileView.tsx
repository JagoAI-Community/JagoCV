        ...
        <div className="max-w-3xl mx-auto mt-10">
          ...
          <div className="bg-white dark:bg-[#0B1221] rounded-[2rem] overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none relative">
            ...
            <div className="h-40 w-full bg-gradient-to-r from-blue-600 to-indigo-600 relative overflow-hidden">
                {/* Decorative patterns */}
                <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] mix-blend-overlay" style={{ backgroundImage: 'radial-gradient(circle, rgba(255,255,255,0.2) 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
            ...
            <div className="px-8 pb-10">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-end -mt-16 mb-6 gap-4">
                    ...
                    <div className="relative group">
                        <div className="p-1.5 bg-white dark:bg-[#0B1221] rounded-full inline-block">
                            <img id="profile-page-img" src={undefined} alt="Profile Large" className="w-28 h-28 rounded-full border-4 border-slate-100 dark:border-slate-800 object-cover shadow-lg" />
                        </div>
                        {/* Optional edit button overlay on hover */}
                ...
                <div className="mb-10">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 dark:text-slate-400 font-medium">
                        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800/50 px-3 py-1.5 rounded-lg border border-slate-200/60 dark:border-slate-700/50">
                            ...
                            <span id="profile-page-email">salmanuyat25@gmail.com</span>
                        </div>
                        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-800/50 px-3 py-1.5 rounded-lg border border-slate-200/60 dark:border-slate-700/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                        {/* Status / Plan Card */}
                        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800/40 dark:to-slate-800/80 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-700/50 relative overflow-hidden group hover:border-blue-200 dark:hover:border-blue-800/50 transition-colors">
                            <div className="absolute -right-6 -top-6 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-colors duration-500"></div>
                            ...
                            <div className="flex justify-between items-center relative z-10">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-extrabold text-slate-900 dark:text-white">Premium Go</p>
                                        <p className="text-[11px] font-semibold text-green-600 dark:text-green-400 mt-0.5">Aktif Selamanya</p>
                                    </div>
                                </div>
                                <button id="btn-upgrade-plan" className="text-blue-600 dark:text-blue-400 text-sm font-bold hover:text-blue-700 dark:hover:text-blue-300 transition-colors">Upgrade</button>
                            </div>
                        </div>

                        {/* Statistics / Achievements */}
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-slate-50 dark:bg-slate-800/30 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                <div className="text-2xl font-extrabold text-slate-900 dark:text-white mb-0.5">12</div>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-800/30 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors">
                                ...
                                <div className="text-2xl font-extrabold text-slate-900 dark:text-white mb-0.5">3</div>
                    ...
                    <div className="space-y-3">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-3 md:mt-1">Pengaturan & Bantuan</h4>
                        ...
                        <button id="btn-settings" className="w-full flex items-center justify-between p-3.5 bg-slate-50 dark:bg-slate-800/30 hover:bg-slate-100 dark:hover:bg-slate-800/60 rounded-xl border border-slate-200/80 dark:border-slate-700/50 transition-colors group">
                            ...
                            <svg className="w-4 h-4 text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
                        </button>
